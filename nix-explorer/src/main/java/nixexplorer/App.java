...
//		f.setVisible(true);
	...
	private static void loadIcons(String black) {
		...
		UIManager.put("ServerTools.duIcon",
				new ScaledIcon(
						App.class.getResource("/images/" + black + "_du.png"),
						Utility.toPixel(24), Utility.toPixel(24)));

		UIManager.put("ServerTools.logIcon",
				new ScaledIcon(
						App.class.getResource("/images/" + black + "_log.png"),
						Utility.toPixel(24), Utility.toPixel(24)));
		...
		UIManager.put("ServerTools.duIcon16",
				new ScaledIcon(
						App.class.getResource("/images/" + black + "_du.png"),
						Utility.toPixel(16), Utility.toPixel(16)));
...
//					new LineBorder(selection, Utility.toPixel(1)));
			...
			UIManager.put("FormattedTextField.selectionForeground",
					selectionForeground);
